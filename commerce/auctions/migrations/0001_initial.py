    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.CharField(default=None, max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bids_made', models.CharField(default=None, max_length=64)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('username', models.CharField(default=None, max_length=64)),
                ('user_linking', models.ManyToManyField(blank=True, related_name='list_info', to='auctions.auction_listings')),
            ],
        ),
        migrations.CreateModel(
            name='User',
